...
export default function AdminPage() {
  ...
  async function sendMagicLink() {
    ...
    alert('Check your email for the magic link! Once you click it, you will be signed in.')
  }

  // Upload media and insert item
  async function handleUploadAndInsert() {
    ...
    setMessage('✅ Item created — refresh the homepage to see it.')
  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      <h2 className="text-xl font-semibold mb-4">Admin — Add Stavrin Item</h2>
      ...
      <label className="block mb-2">Image / Media (optional)</label>
      <input
        type="file"
        accept="image/*,audio/*"
